...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ebagshare`.`T_PRESICION` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ebagshare`.`T_PRESICION_HISTORY` (
  `id_offre` INT NOT NULL,
  `numero_vol` VARCHAR(45) NOT NULL,
  `dimensionL` INT NOT NULL,
  `dimensionH` INT NOT NULL,
  ...
  CONSTRAINT `presH`
    FOREIGN KEY (`id_offre`)
    REFERENCES `ebagshare`.`T_PRESICION` (`id_offre`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Data for table `ebagshare`.`T_PRESICION`
-- -----------------------------------------------------
START TRANSACTION;
USE `ebagshare`;
INSERT INTO `ebagshare`.`T_PRESICION` (`id_offre`, `numero_vol`, `dimensionL`, `dimensionH`, `nom_company`, `Detail`) VALUES (1, 'TU263', 20, 30, 'TunisAir', 'pas alcool svp. (habib)');
